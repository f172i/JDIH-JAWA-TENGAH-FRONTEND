        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data Master Banner<h1>
                            <!--begin::Separator-->
                    ...
                    <div class="card card-flush h-xl-100">
                        <div class="card-header">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800">Data Banner</span>
                            </h3>
...
@section('script')
    ...
    <script>
        $('#datatables').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '{{ route('admin.master.banner.datatable') }}',
                type: 'post',
                data: {
                    "_token": "{{ csrf_token() }}"
                }
        ...
        $('#datatables tbody').on('click', '.hapusb', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.showLoading()
                    $.ajax({
                        url: '{{ route('admin.master.banner.delete') }}',
                        type: 'post',
                        data: {
                            id: id,
                            _token: "{{ csrf_token() }}"
    ...
    <script>
        $('#tambahphproses').on('click', function() {
            ...
            axios({
                    method: "post",
                    url: "{{ route('admin.master.banner.store') }}",
                    data: {
                        name: $('#name').val(),
                        file: $('#file')[0].files[0],
                        _token: "{{ csrf_token() }}"
